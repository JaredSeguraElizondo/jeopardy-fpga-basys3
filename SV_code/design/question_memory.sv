...
module question_memory (
    ...
    //   0  - 31 : enunciado  → tipo_o = 000
    //   32 - 45 : opcion A   → tipo_o = 001
    //   46 - 59 : opcion B   → tipo_o = 010
    //   60 - 73 : opcion C   → tipo_o = 011
    //   74 - 88 : opcion D   → tipo_o = 100
   //   88      : respuesta correcta → tipo_o = 101
    assign tipo_o = (contador <= 7'd31) ? 3'b000 :
                    (contador <= 7'd45) ? 3'b001 :
                    (contador <= 7'd59) ? 3'b010 :
                    (contador <= 7'd73) ? 3'b011 :
                    (contador <= 7'd87) ? 3'b100 :
                                        3'b101;
